...
const SideBar = () => {
    ...
    return (
        <div className="flex flex-col w-full md:w-64 bg-white md:h-screen border-r relative" style={{ borderColor: "#D5D7DA" }}>
            <div className={`flex justify-between md:justify-left w-full px-8 items-center  mt-2`}>
                <div className="flex items-center justify-center gap-4 h-12 cursor-pointer">
                    <img src={'/assets/logo.svg'} alt={'logo'} className={`w-6`}/>
            ...
            >
                <div
                    ...
                    <div className="flex flex-col items-center py-1 mx-4 cursor-pointer">
                        <span className="mt-2 text-sm border p-2 rounded-xl flex gap-2 items-center w-full justify-between" style={{ borderColor: "#D5D7DA" }}>
                            <span className="text-ellipsis overflow-hidden whitespace-nowrap">Akkala Harish Goud's repositories</span>
                    ...
                    <nav className="flex-1 px-4 py-2 space-y-2">
                        ...
                        <a
                            ...
                            className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100"
                        >
                            <span className="flex-shrink-0"><AcademicCapIcon className={`w-6`}/></span>
                    ...
                    <div className="px-4 mb-4 space-y-2">
                        <a
                            ...
                            className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100"
                        >
                            <span className="flex-shrink-0"><PhoneIcon className={`w-6`}/></span>
                        ...
                        <a
                            ...
                            className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100"
                        >
                            <span className="flex-shrink-0"><ArrowRightStartOnRectangleIcon className={`w-6`}/></span>
